...
select:{row:"active"}}),c.extend(!0,b.TableTools.DEFAULTS.oTags,{collection:{container:"ul",button:"li",liner:"a"}}))};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],f):"object"===typeof exports?f(require("jquery"),require("datatables.net")):jQuery&&f(jQuery,jQuery.fn.dataTable)})(window,document);
